...
//var sh_serial = require('./serial_rpi');
...
fs.readFile('conf.xml', 'utf-8', function (err, data) {
    if (err) {
		...
		// arduino port
		usearduinoport = conf.arduino.parentport;
	...
	net.createServer(function (socket) {
       ...
       }).listen(usearduinoport, function() {
                    console.log('TCP Server ( '+ uselocal+ ' ) is listening on port ' + usearduinoport);
       });
    }
});
